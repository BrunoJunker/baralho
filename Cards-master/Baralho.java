...
public class Baralho {
	...
	public Baralho() {	
		...
		for (int contador = 0; contador < baralho.length; contador++) {
			baralho[contador] = new Carta(faces[contador % 10], naipes[contador / 10]);
            baralho[contador].setValue();
		}		
	}
    ...
    public int verificaValor(){
        return baralho[cartaAtual++].getValue();
    }
